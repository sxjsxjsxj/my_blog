...
class UserRegisterSerializers(serializers.Serializer):
    ...
    u_username = serializers.CharField(required=True,max_length=10,
                                       ...
                                       error_messages={
                                            'required':'注册账号必填',
                                            'blank': '注册账号不能为空',
                                            'max_length':'注册账号不能超过10字符',
                                            'min_length': '注册账号不能少于3字符'
                                       })
    ...
    u_password = serializers.CharField(required=True,max_length=10,
                                       ...
                                       error_messages={
                                            'required':'注册密码必填',
                                            'blank': '注册密码不能为空',
                                            'max_length':'注册密码不能超过10字符',
                                            'min_length': '注册密码不能少于5字符'
                                       })
    ...
    u_password2 =  serializers.CharField(required=True,max_length=10,
                                       ...
                                       error_messages={
                                            'required':'注册确认密码必填',
                                            'blank':'注册确认密码不能为空',
                                            'max_length':'注册确认密码不能超过10字符',
                                            'min_length': '注册确认密码不能少于5字符'
                                       })
    ...
    def validate(self, attrs):
        ...
        if user:
            raise errors.ParamsException({'code':1001,'msg':'注册账号已存在，请更新账号'})
        # 2、注册密码和确认密码是否一致
...
class UserLoginSerializers(serializers.Serializer):
    u_username = serializers.CharField(required=True, max_length=10,
                                       ...
                                       error_messages={
                                           'required': '登录账号必填',
                                           'blank': '登录账号不能为空',
                                           'max_length': '登录账号不能超过10字符',
                                           'min_length': '登录账号不能少于3字符'
                                       })
    ...
    u_password = serializers.CharField(required=True, max_length=10,
                                       ...
                                       error_messages={
                                           'required': '登录密码必填',
                                           'blank': '登录密码不能为空',
                                           'max_length': '登录密码不能超过10字符',
                                           'min_length': '登录密码不能少于5字符'
                                       })
    ...
    def validate(self, attrs):
        ...
        user = AXFUser.objects.filter(u_username=username).first()
        if not user:
            raise errors.ParamsException({'code': 1004, 'msg': '登录账号不存在，请更新账号'})
        # 2、判断密码是否正确
        if not check_password(password, user.u_password):
            raise errors.ParamsException({'code': 1005, 'msg': '登录密码错误，请重新输入'})
        return attrs

    def login_user(self, validate_attr):
        #登录，返回token参数，且保存token参数到redis
